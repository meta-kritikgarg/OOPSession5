...
public class Graph {
     ...
     * of weight 1, if no Connection between these Vertices already
     * exists in the Graph.
     * 
     * @param one The first node to add
     * @param two The second node to add
     * @return true iff no Connection relating one and two exists in the Graph
     */
     ...
     * ({one, two}, weight) iff no Connection relating one and two 
     * exists in the Graph.
     * 
     * @param one The first Node of the Connection
     * @param two The second Node of the Connection
     * @param weight The weight of the Connection
     * @return true iff no Connection already exists in the Graph
     */
    public boolean addConnection(Node one, Node two){
        ...
        //ensures the Connection is not in the Graph
     ...
     */
    public Connection removeConnection(Connection e){
